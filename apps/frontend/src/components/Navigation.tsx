        ...
        <nav className="flex items-center space-x-1 sm:space-x-3">
          {currentUser ? (
            ...
            <>
              <Link
                href="/#features"
                className="px-3 py-2 rounded-lg text-sm font-medium text-slate-300 hover:bg-slate-900 hover:text-white transition-colors"
              >
                Fitur
              </Link>
              <Link
                href="/#demo"
                className="px-3 py-2 rounded-lg text-sm font-medium text-slate-300 hover:bg-slate-900 hover:text-white transition-colors flex items-center gap-1"
              >
        ...
        <div className="flex items-center space-x-3">
          ...
          {currentUser ? (
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/demo"
                className="hidden sm:inline-flex px-3.5 py-1.5 rounded-lg text-xs font-semibold bg-slate-900 hover:bg-slate-800 text-sky-400 border border-sky-800/60 transition-all items-center gap-1"
              >
              ...
              <Link
                href="/register"
                className="px-3.5 py-1.5 rounded-lg text-xs font-semibold bg-sky-500 hover:bg-sky-400 text-slate-950 transition-all shadow-md shadow-sky-500/20"
              >
                Mulai Trial
              </Link>
            </div>
